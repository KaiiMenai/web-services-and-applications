# categoryDAO.py 
# This program provides the categoryDAO class for managing category data in a database. It includes methods for creating, reading, updating, and deleting category records. The class uses SQLite for simplicity and is designed to be used in a Flask application. 
