# userDAO.py 
# This program provides the userDAO class for managing user data in a database. It includes methods for creating, reading, updating, and deleting user records. The class uses SQLite for simplicity and is designed to be used in a Flask application. 
